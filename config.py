...
class Config():
    ...
    def __init__(self):
        load_dotenv()
        self.cross_server_import = environ.get("CROSS_SERVER_IMPORT")
    ...
    def target_grafana_api_details(self):
        return {
                    "host"    : environ.get('TARGET_GRAFANA_HOST'),
                    "api_key": environ.get('TARGET_GRAFANA_API_KEY'),
                    "auth_key": environ.get('TARGET_GRAFANA_AUTH_KEY'),
                    "username": environ.get('TARGET_GRAFANA_USERNAME'),
                    "password": environ.get('TARGET_GRAFANA_PASSWORD')
                }
